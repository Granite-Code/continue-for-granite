...
import { isDevMode } from 'core/setupGranite/commons/constants';
import { ConfiguredModels } from 'core/setupGranite/commons/configuredModels';
import { DOWNLOADABLE_MODELS } from 'core/setupGranite/commons/modelRequirements';
import { ProgressData } from "core/setupGranite/commons/progressData";
import { ModelStatus, ServerStatus } from 'core/setupGranite/commons/statuses';
...
export class SetupGranitePage {
  ...
  private _getWebviewContent(webview: Webview, context: ExtensionContext) {
    ...
    if (context.extensionMode == ExtensionMode.Development) {
      scriptUri = "http://localhost:5173/src/setupGranite/index.tsx";
      stylesUri = "http://localhost:5173/src/setupGranite/App.css";
    } else {
      const extensionUri = context.extensionUri;
